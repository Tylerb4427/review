...
public class FancySnowFlake2 extends AbstractShape {

    public FancySnowFlake2(int x, int y, int w, int h) {
        super(x, y, w, h, Color.WHITE, 0, 3+(int)(Math.random() * 3));
    }
    public FancySnowFlake2(int x, int y, int w, int h, int s) {
